    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mail_theme",
                    models.TextField(max_length=100, verbose_name="тема письма"),
                ),
                (
                    "mail_text",
                    models.TextField(max_length=350, verbose_name="тело письма"),
                ),
                (
                    "is_active",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("success", "Успешно"), ("failed", "Не удалось")],
                        max_length=10,
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="logs", to="servise.client", verbose_name="клиент"
                    ),
                ),
                (
                    "mailing_list",
